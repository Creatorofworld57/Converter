...
const Welcome = () => {
    ...
    useEffect(() => {
        ...
        // пример: переход на другую страницу после обновления type
    }, [type]); // отслеживаем изменения в type
            ...
            <div className="tools__container">
                <div className="tools__item" onClick={() => redirectTo("docxtopdf")}>
                    <a onClick={() => redirectTo("pdfToDoc")}>
                        <div className="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                                <path
                                    ...
                                    fillRule="evenodd" fill="rgb(37.254902%,51.372549%,77.647059%)"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fillRule="evenodd" fill="rgb(86.27451%,89.803922%,98.039216%)"></path>
                                <path
                        ...
                        <div className="tools__item__content">
                            <p>Конвертировать ваши документы в PDF-файл, который будет таким же самым как и оригинальный
                                DOC
                                или DOCX.</p>
                        </div>
                    </a>
                </div>
                <div className="tools__item" onClick={() => redirectTo("docx")}>
                    <a title="PDF в Word">
                        <div className="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                                <path
                        ...
                        <h3>PDF в Word</h3>
                        <div className="tools__item__content">
                            <p>Конвертируйте ваши PDF файлы в легко редактируемые DOC и DOCX документы. Преобразованный
                                WORD документ будет точным почти на 100%.</p>
                        </div>
                    </a>
                </div>
                <div className="tools__item" onClick={() => redirectTo("jpgtopdf")}>
                    <a  title="JPG в PDF" >
                        ...
                        <h3>JPG в PDF</h3>
                        <div className="tools__item__content">
                            <p>Конвертируйте ваши изображения в формат PDF. Регуляция ориентации и полей.</p>
                        </div>
                    </a>
                </div>
                <div className="tools__item" onClick={() => redirectTo("xlstopdf")}>
                    <a title="Excel в PDF">
                        ...
                        <h3>Excel в PDF</h3>
                        <div className="tools__item__content">
                            <p>Преобразование ваших таблиц с колонками в PDF файл, с учетом ширины PDF. Книжная или
                                альбомная ориентация. Ваш выбор.</p>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div className="tools__containerForTools">
                <div className="tools__item" onClick={() => redirectTo("pdfmerge")}>
                    <a  title="Объединить PDF">
                        ...
                        <div className="tools__item__content">
                            <p>Объединяйте PDF файлы и упорядочите их легко и быстро в любом порядке, который вам
                                нравится.</p>
                        </div>
                    </a>
                </div>
                        ...
                        <div className="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                                <path
                                    ...
                                    fill-rule="evenodd" fill="rgb(67.058824%,41.176471%,57.647059%)"></path>
                                <path
